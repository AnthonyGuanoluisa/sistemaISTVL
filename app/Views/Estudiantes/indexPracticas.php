...
<div class="container-xxl flex-grow-1 container-p-y">
    <div class="d-flex justify-content-between align-items-center mb-4">
        <h4 class="fw-bold py-3 mb-4">
            <span id="displayComment" class="text-muted fw-light">Practicas /</span>Estudiantes<span id="dynamic-content"></span>
        </h4>
                                    ...
                                    <div class="form-group">
                                        <div class="row">
                                            ...
                                            <div class="col mb-2">
                                                ...
                                                <select name="sexoEstudiante" id="sexoEstudiante" class="form-select" required>
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        $.ajax({
                            ...
                            .fail(function() {
                                Swal.fire("Información!", "Error: No se puede eliminar al estudiante, debido a que se encuentra realizando una de las Actividades", "info");
                            })
                            .always(function() {
                                listarDatos();
                            });

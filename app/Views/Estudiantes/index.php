...
<div class="container-xxl flex-grow-1 container-p-y">
    <div class="d-flex justify-content-between align-items-center mb-4">
        <h4 class="fw-bold py-3 mb-4"><span id="displayComment" class="text-muted fw-light">Administrador/</span>Estudiantes<span id="dynamic-content"></span></h4>
...
<script>
    ...
    function listarDatos() {
        ...
        $("#listadoDatos").load("<?= base_url('/lista-estudiantes'); ?>", {
            urlCode
            ...
            case 'eliminarRegistro':
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        $.ajax({
                                type: 'post',
                                url: "<?= base_url('/eliminar-estudiantes'); ?>",
                                dataType: 'json',
                                data: {
                            ...
                            .fail(function() {
                                Swal.fire("Información!", "Los datos del estudiante, constan en los litados", "info");
                            })
                            .always(function() {
                                listarDatos();
                            });
    ...
    $(document).ready(function() {
        $('#formDatos').validate({
            ...
            submitHandler: function(form) {
                $.post("<?= base_url('/gestion-estudiantes') ?>", $("#formDatos").serialize())
                    .done(function(data) {
                        if (data) {
                            data = data.replace('"', '');
                            var row = data.split('|');
    ...
    function editarRegistro(id) {
        ...
        $.ajax({
                type: 'post',
                url: "<?= base_url('/buscar-estudiantes'); ?>",
                dataType: 'json',
                data: {
                    cedulaEstudiante: id
                }

...
<div class="container-xxl flex-grow-1 container-p-y">
    <div class="d-flex justify-content-between align-items-center mb-4">
        <h4 class="fw-bold py-3 mb-4">
            <span id="displayComment" class="text-muted fw-light">Administrador/</span>Tutores
        </h4>
                                    ...
                                    <div class="form-group">
                                        <div class="row">
                                            <div class="col mb-2">
                                                ...
                                                <input type="text" name="cedulaTutor" id="cedulaTutor" class="form-control" pattern="\d{10}" title="Debe contener 10 dígitos" required />
                                            </div>
                                            <div class="col mb-0">
...
<script>
    ...
    function listarDatos() {
        ...
        $("#listadoDatos").load("<?= base_url('/lista-tutores'); ?>", {
            urlCode
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        $.ajax({
                            ...
                            .fail(function() {
                                Swal.fire("Información!", "El tutor esta siendo utilizado", "info");
                            })
                            .always(function() {
                                listarDatos();
                            });

...
switch ($current_page) {
    case 'empresas-vinculacion':
        $active_menu = 'empresas-vinculacion';
        break;
    case 'estudiantes-vinculacion':
        $active_menu = 'estudiantes-vinculacio';
        break;
    case 'proyecto':
        $active_menu = 'proyecto';
        break;
    case 'listadoVinculacion':
        $active_menu = 'listadoVinculacion';
        break;
    case 'matriz-vinculacion':
        $active_menu = 'matriz-vinculacion';
        break;
}
?>
<!DOCTYPE html>
            ...
            <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
                <div class="app-brand demo">
                    <span class="app-brand-logo demo">
                        <a href="<?php echo base_url('vinculacion'); ?>">
                ...
                <ul class="menu-inner py-1">
                    ...
                    <!-- Empresas -->
                    <li class="menu-item <?php echo ($active_menu == 'empresas-vinculacion') ? 'active open' : ''; ?>">
                        <a href="<?php echo base_url('empresas-vinculacion'); ?>" class="menu-link">
                            <i class="menu-icon tf-icons bx bx-buildings"></i>
                            <div data-i18n="Empresas">Empresas</div>
                        </a>
                    </li>
                    <!-- Estudiantes -->
                    <li class="menu-item <?php echo ($active_menu == 'estudiantes-vinculacio') ? 'active open' : ''; ?>">
                        <a href="<?php echo base_url('estudiantes-vinculacion'); ?>" class="menu-link ">
                            <i class="menu-icon tf-icons bx bxs-user-detail"></i>
                            <div data-i18n="Estudiantes">Estudiantes</div>
                        </a>
                    </li>
                    <!-- Proyectos -->
                    <li class="menu-item <?php echo ($active_menu == 'proyecto') ? 'active' : ''; ?>">
                        <a href="<?= base_url('proyecto'); ?>" class="menu-link">
                            <i class="menu-icon tf-icons bx bx-briefcase-alt-2"></i>
                            <div data-i18n="Proyectos">Proyectos</div>
                        </a>
                    </li>
                    <!-- Listado -->
                    <li class="menu-item <?php echo ($active_menu == 'listadoVinculacion') ? 'active' : ''; ?>">
                        <a href="<?= base_url('listadoVinculacion'); ?>" class="menu-link">
                            <i class="menu-icon bx bx-spreadsheet"></i>
                            <div data-i18n="Listado">Listado</div>
                        </a>
                    </li>
                    <!-- Matriz -->
                    <li class="menu-item <?php echo ($active_menu == 'matriz-vinculacion') ? 'active open' : ''; ?>">
                        <a href="<?php echo base_url('matriz-vinculacion'); ?>" class="menu-link">
                    ...
                    <div class="navbar-nav-right d-flex align-items-center" id="navbar-collapse">
                        ...
                        <div class="navbar-nav align-items-center">
                            <div class="nav-item d-flex align-items-center">
                                ...
                                <input type="text" class="form-control border-0 shadow-none" placeholder="Search..." aria-label="Search..." id="searchInput" onkeyup="searchTable()" />
                            </div>
                        </div>
                        <!-- /Search -->

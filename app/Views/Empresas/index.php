...
<div class="container-xxl flex-grow-1 container-p-y">
    <div class="d-flex justify-content-between align-items-center mb-4">
        <h4 class="fw-bold py-3 mb-4"><span id="displayComment" class="text-muted fw-light">Administrador/Empresas/</span> Lista<span id="dynamic-content"></span></h4>
                                    ...
                                    <div class="form-group">
                                        <div class="row">
                                            ...
                                            <div class="col mb-0">
                                                ...
                                                <input type="text" name="directEmpresa" id="directEmpresa" class="form-control" required />
                                            </div>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <div class="row">
                                            ...
                                            <div class="col mb-0">
                                                ...
                                                <input type="text" name="teleEmpresa" id="teleEmpresa" class="form-control" required />
                                            </div>
                                            <div class="col mb-0">
                                            ...
                                            <div class="col mb-0">
                                                ...
                                                <select name="asignacionEmpresa" id="asignacionEmpresa" class="form-select">
                                                    <?php if ($asignacion) { ?>
                                                        ...
                                                        <?php foreach ($asignacion as $dp) { ?>
                                                            <?php if (strtolower($dp->NombreAsignacion) != 'COORDINACIÓN') { ?>
                                                                <option value="<?= $dp->idAsignacion; ?>"><?= $dp->NombreAsignacion; ?></option>
                                                            <?php } ?>
                                                        <?php } ?>
                                                    <?php } ?>
                                                </select>
...
<script>
    ...
    function listarDatos() {
        ...
        $("#listadoDatos").load("<?= base_url('/lista-empresas'); ?>", {
            urlCode: urlCode,
            name: name
                        ...
                        $.ajax({
                            ...
                            .done(function(data) {
                                if (data) {
                                    ...
                                    Swal.fire("Error!", "La empresa esta siendo ocupada", "error");
                                }
                            })
                            .fail(function() {

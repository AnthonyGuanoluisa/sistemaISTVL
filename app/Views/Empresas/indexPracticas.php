...
<div class="container-xxl flex-grow-1 container-p-y">
    <div class="d-flex justify-content-between align-items-center mb-4">
        <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light"> Practicas/</span> Empresas</h4>
                                        ...
                                        <div class="row">
                                            <div class="col mb-0">
                                                ...
                                                <select name="asignacionEmpresa" id="asignacionEmpresa" class="form-select">
                                                    <option value="<?= $cargoUsuario; ?>"><?= $nombreCargoUsuario; ?></option>
                                                </select>
                                            </div>
                                            <div class="col mb-0">
...
<script>
    ...
    function listarDatos() {
        ...
        $("#listadoDatos").load("<?= base_url('/lista-empresas-asignacion'); ?>", {
            urlCode
    ...
    function gestionRegistro(aObject) {
        ...
        $("#formDatos").find('.is-invalid').removeClass('is-invalid');
        $("#formDatos").find('.error').removeClass("error");

        switch (accion) {
            case 'insertarRegistro':
                $("#idEmpresa").val("");
                $("#exampleModalLabel4").text("Nuevo Registro");
                $("#exLargeModal").modal('show');
                break;
            case 'editarRegistro':
                $("#exampleModalLabel4").text("Editar Registro");
            ...
            case 'eliminarRegistro':
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        $.ajax({
                                type: 'post',
                                url: "<?= base_url('/eliminar-empresas-asignacion'); ?>",
                                dataType: 'json',
                                data: {

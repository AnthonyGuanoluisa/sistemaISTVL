...
<div class="container-xxl flex-grow-1 container-p-y">
    <div class="d-flex justify-content-between align-items-center mb-4">
        <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Practicas /</span> Listado DSW</h4>
                        ...
                        <div class="modal-dialog modal-xl" role="">
                            <div class="modal-content">
                                ...
                                <div style="text-align: center;">
                                    <label class="form-label" style="font-size: 24px; color: #4d8495 ;">PRACTICAS I</label>
                                </div>
                                <form class="modal-body" id="formDatos" method="post" onsubmit="convertToUppercase();">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <br>
                                        <div style="text-align: center;">
                                            <label class="form-label" style="font-size: 24px; color: #4d8495  ;">PRACTICAS II</label>
                                        </div>
                                        <div class="row">
                                            <div class="col mb-2">
                                                ...
                                                <div class="col mb-2">
                                                    ...
                                                    <select name="cursoPracticasDOS" id="cursoPracticasDOS" class="form-select">
                                                        <?php if ($cursos) { ?>
                                                            <option value="">SELECCIONE...</option>
                                                            <?php foreach ($cursos as $dp) { ?>
                                                                <option value="<?= $dp->Curso; ?>"><?= $dp->NCurso; ?></option>
                                                            <?php } ?>
                                                        <?php } ?>
                                                    </select>
                                                </div>

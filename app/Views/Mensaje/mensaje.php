  ...
  <body>
    ...
    <div class="container-xxl container-p-y">
      <div class="misc-wrapper">
        <h2 class="mb-2 mx-2">Error :(</h2>
        <p class="mb-4 mx-2">Oops! 😖 El usuario no tiene acceso a este pagina.</p>
        <div class="mt-3">
          <img
            src="<?php echo base_url('assets/img/illustrations/page-misc-error-light.png');?>"

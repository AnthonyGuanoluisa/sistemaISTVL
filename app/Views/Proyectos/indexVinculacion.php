...
<div class="container-xxl flex-grow-1 container-p-y">
    <div class="d-flex justify-content-between align-items-center mb-4">
        <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Vinculacion /</span> Proyectos</h4>
                                ...
                                <form class="modal-body" id="formDatos" method="post" onsubmit="convertToUppercase();">
                                            ...
                                            <select name="empresaProyecto" id="empresaProyecto" class="form-select">
                                                <?php if ($empresa) { ?>
                                                    ...
                                                    <?php foreach ($empresa as $dp) { ?>
                                                        <option value="<?= $dp->id; ?>"><?= $dp->Nombre_empresa; ?></option>
                                                    <?php } ?>
                                                <?php } ?>
                                            </select>
                                        </div>
                                    ...
                                    <div class="form-group">
                                        <div class="col mb-0">
                                            ...
                                            <select name="carreraProyecto" id="carreraProyecto" class="form-select">
...
<script>
    ...
    function listarDatos() {
        ...
        $("#listadoDatos").load("<?= base_url('/lista-proyecto'); ?>", {
            urlCode
        ...
        $.ajax({
            ...
            .done(function(data) {
                $(data).each(function(i, v) {
                    ...
                    $('#empresaProyecto').val(v.empresaProyecto);
